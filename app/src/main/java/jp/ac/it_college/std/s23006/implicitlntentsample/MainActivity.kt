...
class MainActivity : AppCompatActivity() {
    ...
    // FusedLocation で使う3つのオブジェクトを入れておくプロパティ
    ...
    private val permissionRequestLauncher = registerForActivityResult(
        ...
        // ユーザ同意ダイアログから戻ってきたらどうするかの処理をここで実装
        when {
